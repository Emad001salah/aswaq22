    ...
    try {
      ...
      if (stored) {
        ...
        const sampleApps: Application[] = [
          {
            id: "app_seed_1",
            adId: myJobs[0]?.id || "sample_job_id",
            adTitle: myJobs[0]?.title || "مطلوب محاسب مالي ذو خبرة لديه مهارات عالية",
            adCategory: "jobs",
            applicantId: "user_seed_1",
            applicantName: "أحمد بن علي",
            applicantPhone: "+000 000000000",
            email: "ahmed.ali@example.com",
            coverLetter: "السلام عليكم، يشرفني جداً التقدم لهذه الوظيفة الشاغرة. لدي خبرة 4 سنوات في العمليات المحاسبية واستخدام البرامج المالية الشهيرة. حاصل على بكالوريوس محاسبة بامتياز.",
            experience: "Intermediate (3-5 years)",
            status: "pending",
            appliedAt: new Date(Date.now() - 3600000 * 4).toISOString() // 4 hours ago
          },
          {
            id: "app_seed_2",
            adId: myJobs[0]?.id || "sample_job_id",
            adTitle: myJobs[0]?.title || "مطلوب محاسب مالي ذو خبرة لديه مهارات عالية",
            adCategory: "jobs",
            applicantId: "user_seed_2",
            applicantName: "سارة المهدي",
            applicantPhone: "+000 000000000",
            email: "sara.mahdi@example.com",
            coverLetter: "مرحباً بكم، أنا مهتمة جداً بالانضمام لفريقكم كمحاسبة مالية. أمتلك المهارات اللازمة لتدقيق الحسابات وتنظيم البيانات الختامية السنوية. ملتزمة ودقيقة جداً في العمل.",
