...
export const CATEGORIES: Category[] = [
  ...
  { id: 'phones', nameAr: 'هواتف وأجهزة ذكية', nameEn: 'Phones & Devices', icon: 'Smartphone' },
  { id: 'electronics', nameAr: 'أجهزة منزلية ومطابخ', nameEn: 'Home Appliances', icon: 'Tv' },
  { id: 'laptops', nameAr: 'كمبيوتر ولابتوب', nameEn: 'Computers & Laptops', icon: 'Laptop' },
  { id: 'furniture', nameAr: 'أثاث ومستلزمات منزلية', nameEn: 'Furniture & Home', icon: 'Armchair' },
  { id: 'fashion', nameAr: 'موضة وأزياء', nameEn: 'Fashion & Wear', icon: 'Shirt' },
  { id: 'watches', nameAr: 'ساعات ومجوهرات', nameEn: 'Watches & Jewelry', icon: 'Watch' },
  ...
  { id: 'car_rental', nameAr: 'تأجير سيارات ونقل', nameEn: 'Car Rental & Transport', icon: 'Key' },
  { id: 'food', nameAr: 'مواد غذائية وأطعمة', nameEn: 'Food & Groceries', icon: 'Utensils' },
  { id: 'sports', nameAr: 'رياضة وتخييم وألعاب', nameEn: 'Sports & Camping', icon: 'Trophy' },
  { id: 'medical', nameAr: 'مستلزمات طبية وصحية', nameEn: 'Medical Supplies', icon: 'Stethoscope' },
  { id: 'kids', nameAr: 'ألعاب ومستلزمات أطفال', nameEn: 'Toys & Kids Needs', icon: 'Baby' },
  { id: 'books', nameAr: 'كتب وأدوات مكتبية', nameEn: 'Books & Stationery', icon: 'BookOpen' },
  { id: 'heavy_equipment', nameAr: 'معدات ثقيلة وصناعية', nameEn: 'Heavy Machinery', icon: 'Truck' },
  { id: 'building_materials', nameAr: 'مواد بناء ومقاولات', nameEn: 'Building Materials', icon: 'Hammer' },
  { id: 'agriculture', nameAr: 'زراعة وحدائق ومحاصيل', nameEn: 'Agriculture & Gardens', icon: 'Flower2' },
  { id: 'antiques', nameAr: 'تراثيات وعقيق وجنابي', nameEn: 'Antiques & Traditional', icon: 'Compass' },
